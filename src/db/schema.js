...
function createTables(db) {
  ...
  // v5: Add QR Billing flag to company
  if (db.pragma('user_version', { simple: true }) < 5) {
    try { db.exec(`ALTER TABLE company ADD COLUMN qr_billing INTEGER DEFAULT 0`); } catch(e) {}
    db.pragma('user_version = 5');
  }

  // v6: Add MRP, Batch, Mfg Date, Expiry Date to products (QR billing upgrade)
  if (db.pragma('user_version', { simple: true }) < 6) {
    try { db.exec(`ALTER TABLE products ADD COLUMN mrp REAL DEFAULT 0`); } catch(e) {}
    try { db.exec(`ALTER TABLE products ADD COLUMN batch_no TEXT DEFAULT ''`); } catch(e) {}
    try { db.exec(`ALTER TABLE products ADD COLUMN mfg_date TEXT DEFAULT ''`); } catch(e) {}
    try { db.exec(`ALTER TABLE products ADD COLUMN expiry_date TEXT DEFAULT ''`); } catch(e) {}
    db.pragma('user_version = 6');
  }

  // v7: Customer email, company terms, stock adjustments, invoice custom fields, proforma, purchase orders
  if (db.pragma('user_version', { simple: true }) < 7) {
    try { db.exec(`ALTER TABLE customers ADD COLUMN email TEXT DEFAULT ''`); } catch(e) {}
    try { db.exec(`ALTER TABLE company ADD COLUMN terms_conditions TEXT DEFAULT ''`); } catch(e) {}
    try { db.exec(`ALTER TABLE sales_invoices ADD COLUMN vehicle_no TEXT DEFAULT ''`); } catch(e) {}
    try { db.exec(`ALTER TABLE sales_invoices ADD COLUMN transport TEXT DEFAULT ''`); } catch(e) {}
    try { db.exec(`ALTER TABLE sales_invoices ADD COLUMN po_number TEXT DEFAULT ''`); } catch(e) {}
    try { db.exec(`ALTER TABLE sales_invoices ADD COLUMN amount_paid REAL DEFAULT 0`); } catch(e) {}
    try { db.exec(`ALTER TABLE sales_invoices ADD COLUMN payment_mode2 TEXT DEFAULT ''`); } catch(e) {}
    try { db.exec(`ALTER TABLE sales_invoices ADD COLUMN amount2 REAL DEFAULT 0`); } catch(e) {}
    db.exec(`
  ...
  // v8: Invoice Templates
  if (db.pragma('user_version', { simple: true }) < 8) {
    try { db.exec(`ALTER TABLE company ADD COLUMN invoice_template TEXT DEFAULT 'standard'`); } catch(e) {}
    try { db.exec(`ALTER TABLE company ADD COLUMN custom_template_html TEXT DEFAULT ''`); } catch(e) {}
