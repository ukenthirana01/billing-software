            ...
            <tr>
              ...
              <td>
                <div class="actions">
                  ...
                  <button class="btn btn-sm btn-danger admin-only" onclick="deleteQuotation(${q.id})"><i class="bi bi-trash-fill"></i></button>
  ...
  box.innerHTML = `
    <div class="modal-header">
      ...
      <div class="flex gap-2">
        ...
        <button class="btn btn-sm btn-danger admin-only" onclick="deleteQuotation(${q.id});document.getElementById('modal-overlay').classList.add('hidden')"><i class="bi bi-trash-fill"></i></button>
